/**
 * `@alchemy.run/cloudflare-frameworks/sveltekit/source` — alchemy Worker source provider for
 * SvelteKit projects.
 *
...
const PROVIDER = "@alchemy.run/cloudflare-frameworks/sveltekit/source";
