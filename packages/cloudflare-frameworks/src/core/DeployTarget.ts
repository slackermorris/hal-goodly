 ...
 * (e.g. `@alchemy.run/cloudflare-frameworks/waku/cloudflare`) selected via the framework's
 * `target` option.
 */
 ...
 * - a module specifier string (e.g. `"@alchemy.run/cloudflare-frameworks/waku/cloudflare"`) —
