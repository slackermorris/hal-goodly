# `@alchemy.run/cloudflare-frameworks/octane`
...
export default Options.make({
  framework: "@alchemy.run/cloudflare-frameworks/octane",
  target: {
    cloudflare: {
...
`@alchemy.run/cloudflare-frameworks/octane/source` subpath (the alchemy Worker source-provider
contract).
